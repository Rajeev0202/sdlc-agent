"""
Implementation for US-004: display my contact information and social media links

Persona: Portfolio Owner
Goal: visitors can reach out to me for opportunities
"""
import logging
...
class US004Feature:
    """Implementation of display my contact information and social media links."""
    ...
    def execute(self, user_id: str = None, **kwargs):
        ...
        Acceptance Criteria:
        - Given a visitor scrolls to contact, when the section loads, then email address is displayed
        - Given the contact section is rendered, when viewed, then social media links are present
        - Given contact information is displayed, when clicked, then email link opens default mail client
