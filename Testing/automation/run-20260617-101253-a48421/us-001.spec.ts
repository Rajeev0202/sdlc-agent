...
test.describe('Story US-001: ', () => {
  test('AC1: System should freeze my active debit card from the card details screen', async ({ page }) => {
    ...
    // Assert: Verify System should freeze my active debit card from the
